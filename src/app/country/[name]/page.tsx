        ...
        <div>
          ...
          >
            <div>
              ...
              <p className='dark:text-gray-300 mb-1'><strong className='text-very-dark-blue-light dark:text-gray-300'>Población:</strong> {country.population.toLocaleString()}</p>
